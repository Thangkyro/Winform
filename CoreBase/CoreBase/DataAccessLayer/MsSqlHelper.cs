...
namespace CoreBase.DataAccessLayer
{
    ...
    public sealed class MsSqlHelper
    {
        ...
        public static void SetDefaultValueForTable(DataTable dt)
        {
            foreach (DataColumn dc in dt.Columns)
            {
                dc.DefaultValue = MsSqlHelper.GetDefaultValueOfColumn(dc);
            }
            

        }
        public static object GetDefaultValueOfColumn(DataColumn col)
        {
        ...
        public static int ExecuteNonQuery(SqlConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                //pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                SqlParameter[] commandParameters = MsSqlHelperParameterCache.GetSpParameterSet(connection.ConnectionString, spName);
        ...
        public static int ExecuteNonQuery(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            {
                //pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                SqlParameter[] commandParameters = MsSqlHelperParameterCache.GetSpParameterSet(transaction.Connection.ConnectionString, spName);
        ...
        /// <summary>
    /// MsSqlHelperParameterCache provides functions to leverage a static cache of procedure parameters, and the
    ...
    public sealed class MsSqlHelperParameterCache
    {
        ...
        //Since this class provides only static methods, make the default constructor private to prevent 
        //instances from being created with "new MsSqlHelperParameterCache()".
