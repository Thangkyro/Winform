...
namespace Nail.Core
{
    public class Updater
    {
        ...
        public UpdateManifest LocalConfig
        {
        ...
        public UpdateManifest RemoteConfig
        {
        ...
        public delegate void CheckForUpdateEventHandler(EventArgs args);
        ...
        private void Check (object state)
        {
            ...
            Process.Start("Nail.Update.exe");
            System.Windows.Forms.Application.Exit();

            System.Windows.Forms.MessageBox.Show("Update new");
